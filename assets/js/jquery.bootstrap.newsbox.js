...
(function ($, w, d, undefined) {
    ...
    var NewsBox = {
        ...
        prepareLayout: function() {
            ...
            //get width of the very first self.options.newsPerPage news
            var width = 0;

            $.map(self.$elem.find(self.newsTagName), function( newsItem, index ) {
                if ( index < self.options.newsPerPage ) {
                    width = parseInt(width) + parseInt($(newsItem).width()) + 10;
                }
            });

            $(self.elem).css({"overflow-x": "hidden", "width": "100%"});

            //recalculate news box width for responsive interfaces
            $( w ).resize(function() {
